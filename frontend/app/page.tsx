      ...
      <nav className={`fixed top-0 w-full z-[100] transition-all duration-500 ${scrollY > 20 ? 'py-4 bg-black/60 backdrop-blur-2xl border-b border-white/5' : 'py-8 bg-transparent'}`}>
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 flex items-center justify-between">
          ...
          <div className="flex gap-4">
            <button className="hidden sm:block bg-white/5 border border-white/10 px-6 py-2 rounded-full font-black text-[10px] uppercase tracking-widest hover:bg-white/10 transition-all">Login</button>
