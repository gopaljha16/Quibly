            ...
            <div className="mb-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 flex items-center gap-2 p-3 rounded-[3px] transition-colors ${
                    channelType === 'TEXT'
                      ...
                      : 'bg-[#0d0805] border-2 border-transparent hover:border-[#f3c178]/50'
                  }`}
                  disabled={isLoading}
                >
                  ...
                  <span className="text-sm font-medium text-[#DBDEE1]">Text</span>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="text-sm font-medium text-[#DBDEE1]">Voice</span>
                </button>
              </div>
            </div>
