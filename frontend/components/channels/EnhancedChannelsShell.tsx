  ...
  return (
    <div className="h-screen w-screen bg-[#313338] text-white flex overflow-hidden font-sans">
      ...
      <div className="w-[72px] bg-[#1E1F22] flex flex-col items-center py-3 gap-2 overflow-y-auto scrollbar-hide">
        {/* Home/DM Button */}
        <div className="relative group">
          <div className={`absolute left-0 top-1/2 -translate-y-1/2 w-1 bg-white rounded-r-full transition-all duration-200 ${
            route.isMe ? 'h-10' : 'h-2 group-hover:h-5 opacity-0 group-hover:opacity-100'
          }`} />
          <button
            type="button"
            onClick={goToMe}
            className={`w-12 h-12 flex items-center justify-center text-lg font-bold transition-all duration-200 overflow-hidden ${
              route.isMe 
                ...
                : 'bg-[#313338] text-gray-100 group-hover:bg-[#5865f2] group-hover:text-white rounded-[24px] group-hover:rounded-[16px]'
            }`}
          >
        ...
        {serversLoading ? (
          ...
          servers.map((s) => (
            <div key={s._id} className="relative group">
              <div className={`absolute left-0 top-1/2 -translate-y-1/2 w-1 bg-white rounded-r-full transition-all duration-200 ${
                s._id === route.serverId ? 'h-10' : 'h-2 group-hover:h-5 opacity-0 group-hover:opacity-100'
              }`} />
              <button
                type="button"
        ...
        <div className="relative group">
           <button
            ...
            className="w-12 h-12 rounded-[24px] bg-[#313338] hover:bg-[#23a559] group-hover:rounded-[16px] transition-all duration-200 flex items-center justify-center text-[#23a559] hover:text-white text-2xl font-normal group"
            title="Add a Server"
          >
        ...
        <div className="relative group">
          <button
            ...
            className="w-12 h-12 rounded-[24px] bg-[#313338] hover:bg-[#23a559] group-hover:rounded-[16px] transition-all duration-200 flex items-center justify-center text-[#23a559] hover:text-white"
            title="Join a Server"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" className="fill-current">
      ...
      {/* Channels Sidebar */}
      <div className="w-[240px] bg-[#2B2D31] flex flex-col rounded-tl-[8px]">
        {/* Server Header */}
        ...
        {/* Search Bar */}
        <div className="p-2 border-b border-[#1F2023] shadow-sm">
          <button className="w-full h-7 rounded-[4px] bg-[#1E1F22] text-left px-2 text-sm text-[#949BA4] hover:text-[#DBDEE1] transition-colors flex items-center">
        ...
        <div className="flex-1 overflow-y-auto px-2 py-3 scrollbar-thin scrollbar-thumb-[#1A1B1E] scrollbar-track-[#2B2D31]">
          ...
          {route.isMe ? (
            <div className="space-y-[2px]">
              ...
              <button className="group w-full px-2 py-2 rounded-[4px] hover:bg-[#35373C] text-[15px] text-[#949BA4] hover:text-[#DBDEE1] text-left flex items-center gap-3 transition-colors">
              ...
              {channels.map((c, idx) => (
                <div
                  ...
                  className={`group relative w-full text-left px-2 py-[6px] rounded-[4px] text-[15px] flex items-center gap-1.5 cursor-pointer ${
                    c._id === route.channelId ? 'bg-[#404249] text-white' : 'hover:bg-[#35373C] text-[#949BA4] hover:text-[#DBDEE1]'
                  }`}
                  onClick={() => {
                    ...
                    {channelMenuOpenId === c._id && (
                      <div className="absolute mt-2 left-0 top-full w-44 rounded border border-[#1F2023] bg-[#111214] shadow-lg z-50 overflow-hidden p-1">
                        <button
                          ...
                          className="w-full text-left px-2 py-1.5 text-sm hover:bg-[#4752C4] text-[#B5BAC1] hover:text-white rounded-[2px]"
                        >
                          Edit Channel
                        </button>
        ...
        <div className="h-[52px] bg-[#232428] px-2 flex items-center gap-1 flex-shrink-0" ref={userMenuRef}>
          <div 
            className="flex items-center gap-2 hover:bg-[#3F4147] rounded-[4px] pl-0.5 pr-2 py-1 cursor-pointer transition-colors min-w-0 -ml-1 mr-auto"
          ...
          {userMenuOpen && (
            <div className="absolute bottom-16 left-2 w-64 rounded bg-[#111214] shadow-2xl z-50 overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-200">
              <div className="h-16 bg-[#23a559] relative">
              ...
              <div className="pt-8 pb-3 px-4 border-b border-[#1F2023] bg-[#111214]">
              ...
              <div className="p-2 bg-[#111214]">
                ...
                {[
                  ...
                  <button
                    ...
                    className={`w-full text-left px-2 py-1.5 rounded-[2px] text-sm hover:bg-[#4752C4] hover:text-white flex items-center gap-3 group transition-colors ${
                      myStatus === status ? 'bg-[#404249] text-white' : 'text-[#B5BAC1]'
                    }`}
                  >
              ...
              <div className="p-2 border-t border-[#1F2023] bg-[#111214]">
                <button 
                  onClick={() => {
                    setUserMenuOpen(false)
                    void handleLogout()
      ...
      <div className="flex-1 flex flex-col bg-[#313338]">
        {/* Channel Header */}
        <div className="h-12 border-b border-[#26272D] flex items-center px-4 gap-3 shadow-sm flex-shrink-0 bg-[#313338]">
            ...
            {members.map((m) => {
              ...
              return (
                <button
                  ...
                  className="w-full px-2 py-1.5 rounded-[4px] hover:bg-[#35373C] transition-colors flex items-center gap-3 group opacity-90 hover:opacity-100"
                >
                  <UserAvatar 
